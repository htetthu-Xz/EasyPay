        ...
        <div class="dropdown mx-5">
            <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                <div class="avatar avatar-md2" >
                    <img src="https://ui-avatars.com/api/?name={{ Auth::guard('admin_user')->user()->name }}&background=random" alt="Avatar">
                </div>
                <div class="text">
                    <h6 class="user-dropdown-name">{{ Auth::guard('admin_user')->user()->name }}</h6>
                    <p class="user-dropdown-status text-sm text-muted">{{ Auth::guard('admin_user')->user()->phone }}</p>
                </div>
            </a>
